	...
	class SmartTemplate
	{
		...
		*/
		function output ( $_top = '' )
		{
			...
			//	Delete Global Movie Array in order to allow multiple use of SmartTemplate class in one script
			unset ($_top);
		}
