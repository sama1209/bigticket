			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					<div class="form-group">
						...
						<div class="col-sm-5" name="username">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" name="password" id="inputpassword" placeholder="请输入原密码" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" name="newpassword" id="inputnewpassword" placeholder="请输入新密码" >
						</div>
					</div>

					<div class="form-group">
						<label for="inputnewpassword2" class="col-sm-2 control-label">再次确认:</label>
						<div class="col-sm-5">
							<input type="password" class="form-control" name="newpassword2" id="inputnewpassword2" placeholder="请输入新密码" >
						</div>
					</div>
...
<script>
	var SCOPE = {
		'save_url' : '/bigticket/admin.php?c=admin&a=savepassword',
