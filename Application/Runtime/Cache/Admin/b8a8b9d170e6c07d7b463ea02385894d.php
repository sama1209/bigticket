    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-dashboard"></i>  <a href="/bigticket/admin.php?c=positioncontent">推荐位管理</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <form action="/bigticket/admin.php" method="get">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <input class="form-control" name="title" type="text" value="<?php echo ($title); ?>" placeholder="电影名称" />
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <tbody>
                            <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><input type="text" size="4" value="<?php echo ($vo["listorder"]); ?>"></td>
                                <td ><?php echo ($vo["position_id"]); ?></td>
                                <td><?php echo ($vo["movie_id"]); ?></td>
                                <td><?php echo (getMovieTitleById($vo["movie_id"])); ?></td>
                                <td><?php echo (getMovieBigById($vo["movie_id"])); ?></td>
                                <td><?php echo (getMovieSmallById($vo["movie_id"])); ?></td>
                                <td>
...
<script>
    var SCOPE = {
        'edit_url' : '/bigticket/admin.php?c=positioncontent&a=edit',
        'set_status_url' : '/bigticket/admin.php?c=positioncontent&a=setStatus',
        'add_url' : '/bigticket/admin.php?c=positioncontent&a=add',
        'listorder_url' : '/bigticket/admin.php?c=positioncontent&a=listorder',
    }
