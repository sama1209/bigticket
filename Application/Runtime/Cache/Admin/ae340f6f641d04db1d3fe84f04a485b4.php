        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" id="movie_id" name="movie_id">
                  ...
                  <?php if(is_array($movie_id)): foreach($movie_id as $key=>$movieMenu): ?><option value="<?php echo ($movieMenu["movie_id"]); ?>"><?php echo ($movieMenu["title"]); ?></option><?php endforeach; endif; ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  name="year">
                  ...
                  <?php if(is_array($year)): foreach($year as $key=>$yearMenu): ?><option value="<?php echo ($yearMenu); ?>"><?php echo ($yearMenu); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  name="month">
                  ...
                  <?php if(is_array($month)): foreach($month as $key=>$monthMenu): ?><option value="<?php echo ($monthMenu); ?>"><?php echo ($monthMenu); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  name="date">
                  ...
                  <?php if(is_array($date)): foreach($date as $key=>$dateMenu): ?><option value="<?php echo ($dateMenu); ?>"><?php echo ($dateMenu); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  name="hour">
                  ...
                  <?php if(is_array($hour)): foreach($hour as $key=>$hourMenu): ?><option value="<?php echo ($hourMenu); ?>"><?php echo ($hourMenu); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  name="minute">
                  <option value="">==请选择具体时间==</option>
                  <?php if(is_array($minute)): foreach($minute as $key=>$minuteMenu): ?><option value="<?php echo ($minuteMenu); ?>"><?php echo ($minuteMenu); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" id="hall_id" name="hall">
                  <option value="">==请选择影厅==</option>
                  <?php if(is_array($hall)): foreach($hall as $key=>$hallMenu): ?><option value="<?php echo ($hallMenu["name"]); ?>"><?php echo ($hallMenu["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="price" class="form-control" id="inputcountry" placeholder="请填写票价">
              </div>
            </div>
