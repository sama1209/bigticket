    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/bigticket/admin.php?c=movie">影厅管理</a>
            </li>
            <li class="active">
              <i class="fa fa-table"></i> 影厅列表
            </li>
          </ol>
        </div>
      </div>
          ...
          <div class="">
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table">
                ...
                <tbody>
                <?php if(is_array($hall)): $i = 0; $__LIST__ = $hall;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hall): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($hall["hall_id"]); ?></td>
                    <td><?php echo ($hall["name"]); ?></td>
                    <td><?php echo ($hall["hall_capacity"]); ?></td>
                    <td><span  attr-status="<?php if($hall['status'] == 1): ?>0<?php else: ?>1<?php endif; ?>" attr-id="<?php echo ($hall["hall_id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off" ><?php echo (status($hall["status"])); ?></span></td>
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($hall["hall_id"]); ?>" ></span>
                      <a href="javascript:void(0)" id="singcms-delete"  attr-id="<?php echo ($hall["hall_id"]); ?>"  attr-message="删除">
...
<script>
  var SCOPE = {
    'jump_url' :'/bigticket/admin.php?c=hall',
    'edit_url' : '/bigticket/admin.php?c=hall&a=edit',
    'add_url' : '/bigticket/admin.php?c=hall&a=add',
    'set_status_url' : '/bigticket/admin.php?c=hall&a=setStatus',
  }
</script>
