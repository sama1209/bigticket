					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="movie_id">
								<option >请选择影片</option>
								<?php if(is_array($movie)): foreach($movie as $key=>$movie): ?><option value="<?php echo ($movie["movie_id"]); ?>"><?php echo ($movie["title"]); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>

					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">推荐位:</label>
						<div class="col-sm-5">
