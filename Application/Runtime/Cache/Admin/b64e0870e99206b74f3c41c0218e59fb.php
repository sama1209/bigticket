                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="password" id="inputpassword" placeholder="" value="<?php echo ($vo["password"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="phone" id="inputphone" placeholder="" value="<?php echo ($vo["phone"]); ?>">
                            </div>
                        </div>
...
<script>
    var SCOPE = {
        'save_url' : '/bigticket/admin.php?c=admin&a=save',
