            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="password" name="password2" class="form-control" id="inputpassword2" placeholder="请填写密码"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="phone" id="inputphone" placeholder="请填写联系电话">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="email" id="inputemail" placeholder="请填写电子邮箱">
                        </div>
                    </div>
