...
<div id="page-wrapper">
    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-dashboard"></i>  <a href="/bigticket/admin.php?c=position">推荐位管理</a>
                    </li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        <div >
            <button url="/bigticket/admin.php?c=positioncontent&a=add" id="button-add" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加 </button>
        </div>
...
<script>
    var SCOPE = {
        'edit_url' : '/bigticket/admin.php?c=position&a=edit',
        'set_status_url' : '/bigticket/admin.php?c=position&a=setStatus',
        'add_url' : '/bigticket/admin.php?c=position&a=add',
    }
    $(".singcms-table #sing-add-position-content").on('click',function(){
        var id = $(this).attr('attr-id');
        window.location.href='/bigticket/admin.php?c=positioncontent&a=index&position_id='+id;
    });
</script>
