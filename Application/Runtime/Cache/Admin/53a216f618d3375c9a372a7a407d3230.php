			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="realname" id="inputrealname" placeholder="" value="<?php echo ($vo["realname"]); ?>">
						</div>
					</div>

					<div class="form-group">
						<label for="inputemail"  class="col-sm-2 control-label">联系电话:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="email" id="inputphone" placeholder="" value="<?php echo ($vo["phone"]); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="inputemail"  class="col-sm-2 control-label">个人邮箱:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="email" id="inputemail" placeholder="" value="<?php echo ($vo["email"]); ?>">
						</div>
					</div>
...
<script>
	var SCOPE = {
		'save_url' : '/bigticket/admin.php?c=admin&a=add',
		'jump_url' : '/bigticket/admin.php?c=admin',
