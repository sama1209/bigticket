...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="/singcms/admin.php?c=index">巨票儿票务管理平台</a>
  </div>
  <!-- Top Menu Items -->
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/singcms/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
...
<script>
  var SCOPE = {
    ...
    'edit_url' : '/singcms/admin.php?c=content&a=edit',
    'add_url' : '/singcms/admin.php?c=content&a=add',
    'set_status_url' : '/singcms/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/singcms/index.php?c=view',
    'listorder_url' : '/singcms/admin.php?c=content&a=listorder',
    'push_url' : '/singcms/admin.php?c=content&a=push',
  }
</script>
