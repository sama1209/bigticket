        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="title" class="form-control" id="inputname" placeholder="请填写片名">
              </div>
            </div>
            <div class="form-group">
              <label for="inputcountry" class="col-sm-2 control-label">所属国家:</label>
              <div class="col-sm-5">
                <input type="text" name="country" class="form-control" id="inputcountry" placeholder="请填写国家">
              </div>
            </div>
            <div class="form-group">
              <label for="inputdirector" class="col-sm-2 control-label">导演:</label>
              <div class="col-sm-5">
                <input type="text" name="director" class="form-control" id="inputdirector" placeholder="请填写导演">
              </div>
            </div>
            <div class="form-group">
              <label for="inputlength" class="col-sm-2 control-label">片长:</label>
              <div class="col-sm-5">
                <input type="text" name="length" class="form-control" id="inputlength" placeholder="请填写片长">
              </div>
            </div>
            <div class="form-group">
              <label for="inputmainactor" class="col-sm-2 control-label">主演:</label>
              <div class="col-sm-5">
                <input type="text" name="mainactor" class="form-control" id="inputmainactor" placeholder="多个请用空格隔开">
              </div>
            </div>
            <div class="form-group">
              <label for="inputtype" class="col-sm-2 control-label">影片类型:</label>
              <div class="col-sm-5">
                <input type="text" name="type" class="form-control" id="inputtype" placeholder="多个请用空格隔开">
              </div>
            </div>
            <div class="form-group">
              <label for="inputdate" class="col-sm-2 control-label">上映日期:</label>
              <div class="col-sm-5">
                <input type="text" name="date" class="form-control" id="inputdate" placeholder="年 - 月 - 日">
              </div>
            </div>
            <div class="form-group">
              <label for="inputgrade" class="col-sm-2 control-label">影片评分</label>
              <div class="col-sm-5">
                <input type="text" name="grade" class="form-control" id="inputgrade" placeholder="请填写评分，若未上映则为10">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                ...
                <img style="display: none" id="upload_org_code_img" src="" width="300" height="150">
                <input id="file_upload_image" name="photo_big" type="hidden" multiple="true" value="">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                ...
                <img style="display: none" id="upload_org_code_img_small" src="" width="150" height="200">
                <input id="file_upload_image_small" name="photo_small" type="hidden" multiple="true" value="">
              </div>
            </div>
